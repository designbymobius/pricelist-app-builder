					...
					// iterate over current manufacturer's products
						array_each( current_manufacturer_products, function(current_product){
							...
							// add product to markup
								markup += "<div class='product' data-attribute-dbid='" + current_product.Id + "' data-attribute-imgsrc='http://res.cloudinary.com/hrowcuozo/image/upload/dpr_1.0,fl_png8,t_default-width/v1407926493/" + current_manufacturer.Name.toLowerCase() + "-" + current_product.Name.toLowerCase().replace(/ /g, "-").replace(/%20/g, "-") + ".jpg'>" + 
